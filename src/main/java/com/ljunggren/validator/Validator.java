    ...
    private void validationChain(Annotation annotation, Item item) {
        ...
        new AlphaNumericValidationChain()
                .nextChain(new AlphaValidationChain()
                        .nextChain(new EmailValidationChain().nextChain(new ExactMatchValidationChain().nextChain(
                                new LengthValidationChain().nextChain(new NotEmptyValidationChain().nextChain(
                                        new NotNullValidationChain().nextChain(new CatchAllValidationChain())))))))
